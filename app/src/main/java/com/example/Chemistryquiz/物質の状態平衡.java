...
public class 物質の状態平衡 extends AppCompatActivity {
    private String CODE;
    @Override
    protected void onCreate(final Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.jotaiheikou);
        MobileAds.initialize(this, getString(R.string.ads_AppId));
        AdView adView = findViewById(R.id.adView);
        AdRequest adRequest = new AdRequest.Builder().build();
        adView.loadAd(adRequest);
        Toolbar toolbar = findViewById(R.id.tool_bar);
        toolbar.setTitle("物質の状態");
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setHomeButtonEnabled(true);

        //ﾎﾞﾀﾝ
        Button sendButton1 = findViewById(R.id.send_button21);
        Button sendButton2 = findViewById(R.id.send_button22);
        Button sendButton3 = findViewById(R.id.send_button23);
